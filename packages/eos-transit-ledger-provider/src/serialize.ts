...
export default function serialize(chainId: any, transaction: any, types?: any) {
  const writer = new asn1.BerWriter();

  //Not sure why then needed this supplied to the function.
  types = fcbuffer.types;
...
function encode(writter: any, buffer: any) {
